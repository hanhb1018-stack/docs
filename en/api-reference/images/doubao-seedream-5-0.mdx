...
All requests are forwarded to Volcengine Ark through GragAPI. You do not need to sign requests yourself; just carry the GragAPI API Key in the header.

```bash
export BASE_URL="https://api.gragapi.com/v1"
...
```bash
curl -X POST "https://api.gragapi.com/v1/images/generations" \
